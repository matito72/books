...
//* LISTA
class ListaFileBackupLoadedState<T extends List<FileBackupModel>>
    extends ImportExportSuccessState {
  const ListaFileBackupLoadedState(List<FileBackupModel> data, String msg)
    : super(data: data, msg: msg);
}

//* DELETE FILE ESPORTATO
class DeletedFileBackupState<T extends int> extends ImportExportSuccessState {
  const DeletedFileBackupState(String msg) : super(msg: msg);
}

//* DELETE ALL
class DeleteAllFileBackupState<T extends int> extends ImportExportSuccessState {
  const DeleteAllFileBackupState(int data, String msg)
    : super(data: data, msg: msg);
}

//* EXPORTED FILE
class ExportedFileBackupState<T extends int> extends ImportExportSuccessState {
  const ExportedFileBackupState(int data, String msg)
    : super(data: data, msg: msg);
}

//* IMPORTED FILE
class ImportedFileBackupState<T extends int> extends ImportExportSuccessState {
  const ImportedFileBackupState(int data, String msg)
    : super(data: data, msg: msg);
}
